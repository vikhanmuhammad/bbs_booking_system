...
import 'package:bbs_booking_system/view/admin/messagesadmin.dart';
import 'package:bbs_booking_system/view/admin/profiladmin.dart';
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ProfilAdmin()),
                    );
                  },
                  child: Icon(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      // Tambah untuk hapus disini
                                      BookingService.deleteBooking(
                                          doc.id, indexMeja);
                                      ProfileService p = ProfileService();
                                      p.deleteBookDataFromUserData(
                                          doc['userBookUID'],
                                          doc['kodeBooking']);
                                      Navigator.of(context).pop();
                                    },
