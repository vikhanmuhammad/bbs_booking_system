...
class DetailRiwayatPesanan extends StatefulWidget {
  final Map<String, dynamic> bookingModel;

  const DetailRiwayatPesanan({Key? key, required this.bookingModel})
      : super(key: key);
...
class _DetailRiwayatPesananState extends State<DetailRiwayatPesanan> {
  @override
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Meja ' + widget.bookingModel['meja'].toString(),
                              style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                widget.bookingModel['lantai'].toString(),
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: screenWidth * 0.05,
                                  fontWeight: FontWeight.bold,
